...
FunctionsToExport = 'Edit-HostsFile', 'Get-Syntax', 'Invoke-Docker', 'Invoke-Docker.Tests', 
               'Invoke-DockerCompose', 'Invoke-DockerCompose.Tests', 'Invoke-Dotnet', 
               'Invoke-DotNet.Tests', 'Invoke-Git', 'Invoke-Git.Tests', 
               'Invoke-GitHubRepository', 'Invoke-GitHubRepository.Tests', 
               'Invoke-ReloadEnvironment', 'Invoke-ReverseSort', 'Out-Menu', 
               'Restart-PSHost', 'Restore-WorkspacePackages', 
...
AliasesToExport = 'hosts', 'Syntax', 'd', 'd', 'dc', 'dc', 'dn', 'dn', 'g', 'g', 'gh', 'gh', 'reload', 'menu', 
               'rwp', 'IsAdmin'
